...
enum KSPROPERTY_BDA_FREQUENCY_FILTER {					// MinProperty=32
	...
	KSPROPERTY_BDA_RF_TUNER_POLARITY,					// get/set		MinData=4		(QPSK1/QPSK2ÇÃÇ›)
	KSPROPERTY_BDA_RF_TUNER_RANGE,						// get/set		MinData=4		(QPSK1/QPSK2ÇÃÇ›)
	KSPROPERTY_BDA_RF_TUNER_TRANSPONDER,				// not supported
	KSPROPERTY_BDA_RF_TUNER_BANDWIDTH,					// get/set		MinData=4		(COFDM/8VSBÇÃÇ›)
...
// KSNODE_BDA_RF_TUNER Input pin, id:0													(QPSK1/QPSK2ÇÃÇ›)
...
enum KSPROPERTY_BDA_DIGITAL_DEMODULATOR {				// MinProperty=32
	...
	KSPROPERTY_BDA_INNER_FEC_TYPE,						// get/set		MinData=4		(QPSK1/QPSK2ÇÃÇ›)
	KSPROPERTY_BDA_INNER_FEC_RATE,						// get/set		MinData=4		(QPSK1/QPSK2ÇÃÇ›)
	...
	KSPROPERTY_BDA_SPECTRAL_INVERSION,					// get/set		MinData=4		(QPSK1/QPSK2ÇÃÇ›)
...
// KSNODE_BDA_RF_TUNER Input pin, id:0													(QPSK1ÇÃÇ›)
...
// KSNODE_BDA_RF_TUNER Input pin, id:0													(QPSK2ÇÃÇ›)
